    ...
    <div class="app-container">
        ...
        <el-form label-width="70px" size="small">
          ...
          <el-row style="display:flex">
            <el-button type="primary" icon="el-icon-search" size="mini"  @click="fetchData()" :disabled="$hasBP('bnt.sysLoginLog.list')  === false">搜索</el-button>
      ...
      style="width: 100%;margin-top: 10px;">
        ...
        <el-table-column prop="username" label="登录用户"  align="center"/>
        <el-table-column prop="msg" label="登录信息"  align="center"/>
